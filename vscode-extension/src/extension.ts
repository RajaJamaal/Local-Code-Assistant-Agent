...
// const STORAGE_KEY = 'localCodeAssistant.state.v2';
...
//     console.log('[local-code-assistant][postState] sending hydrate', { includeHistory: formState.includeHistory, historyCount: responseHistory.length });
...
//         if (responsesEl) responsesEl.style.display = 'block';
//       }
...
//             state = { ...state, ...message.formState };
//             vscode.setState(state);
//             applyStateToForm();
//           }
//           if (Array.isArray(message.suggestions)) {
//             suggestionPool = message.suggestions;
//             console.log('[local-code-assistant/webview] hydrate/suggestions', suggestionPool.length);
//             renderSuggestions(getFilterToken());
//           }
//         }
//       });
